...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('orders/payment/{orderId}', [\App\Http\Controllers\OrderController::class, 'payment'])->name('orders.payment');
    Route::post('order/update-payment-status/{order}', [\App\Http\Controllers\OrderController::class, 'checkAndUpdatePaymentStatus'])->name('update.payment.status');
    ...
    Route::group(['middleware' => 'isAdmin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
        ...
        Route::resource('orders', \App\Http\Controllers\Admin\OrderController::class)->only(['index', 'show', 'destroy', 'update']);
        ...
        Route::get('reports/laporan-kas', [\App\Http\Controllers\Admin\ReportController::class, 'laporanKas'])->name('reports.laporanKas');
        Route::get('reports/laporan-transaksi', [\App\Http\Controllers\Admin\ReportController::class, 'laporanTransaksi'])->name('reports.laporanTransaksi');
    });
});
