<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseReports" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ request()->is('admin/reports/laporan-kas') ? 'active' : '' }}" href="{{ route('admin.reports.laporanKas') }}"> <i class="fa fa-briefcase mr-2"></i> {{ __('Cash Report') }}</a>
                        <a class="collapse-item {{ request()->is('admin/reports/laporan-transaksi') ? 'active' : '' }}" href="{{ route('admin.reports.laporanTransaksi') }}"> <i class="fa fa-briefcase mr-2"></i> {{ __('Transaction Report') }}</a>
                    </div>
                </div>
            </li>
