                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <select name="city_id" class="form-control" disabled>
																<option {{ $shipment->city_id == 'jaktim' ? 'selected' : null }} value="jaktim">Jakarta Timur</option>
																<option {{ $shipment->city_id == 'jakbar' ? 'selected' : null }} value="jakbar">Jakarta Barat</option>
																<option {{ $shipment->city_id == 'jakut' ? 'selected' : null }} value="jakut">Jakarta Utara</option>
																<option {{ $shipment->city_id == 'jaksel' ? 'selected' : null }} value="jaksel">Jakarta Selatan</option>
																<option {{ $shipment->city_id == 'jakpus' ? 'selected' : null }} value="jakpus">Jakarta Pusat</option>
                                </select> 
                            </div>
                            <div class="col-md-6">
					...
					<div class="row">
						<div class="col-xl-6 col-lg-6">
							...
							<address>
								...
								{{ \App\Helpers\CityHelper::getCityName( $shipment->order->customer_city_id) }}
								<br> {{ $shipment->order->customer_postcode }}<br>
