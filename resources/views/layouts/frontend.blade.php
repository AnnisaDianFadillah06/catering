                    ...
                    <div class="container-fluid">
                        <div class="header-bottom-wrapper">
                            <div class="logo-2 furniture-logo ptb-30">
                                <a href="/">
                                    <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/KremMerahSederhanaIlustrasiKateringRumahanLogo.png') }}" alt="">
                                </a>
                            </div>
                            <div class="menu-style-2 furniture-menu menu-hover">
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('shop.index') }}">food products</a>
                                        </li>
                    ...
                    <div class="widget-wrapper">
                        ...
                        <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/KremMerahSederhanaIlustrasiKateringRumahanLogo.png') }}" alt="">
                            <div class="footer-about-2">
                                <p>Bumbu harum memegang peran penting dalam memperkaya cita rasa <br>masakan tradisional maupun modern di banyak belahan dunia.<br>Kesenangan menciptakan hidangan yang lezat dan memikat sering kali <br>dimulai dari perpaduan yang tepat antara bumbu-bumbu harum. <br>Dengan keberagaman dan kreativitas dalam penggunaannya bumbu harum <br>memastikan pengalaman kuliner yang tak terlupakan bagi siapa pun yang menikmatinya.</p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Jl. Cemara No. 83 Kelurahan Jatimekar <br>Kecamatan Jatiasih Bekasi Selatan</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>087888440143 <br>081311251285</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> bumbuharum@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="https://www.instagram.com/bumbuharum/">bumbuharum</a> 2023 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
