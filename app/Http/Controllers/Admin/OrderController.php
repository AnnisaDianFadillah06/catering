...
class OrderController extends Controller
{
    ...
    public function update(Request $request, Order $order)
    {
        ...
        // Menggunakan nilai yang ada di request untuk menghitung ulang grand total
        $baseTotalPrice = $order->base_total_price;
        $shippingCost = $validated['shipping_cost'];
        $grandTotal = $baseTotalPrice + $shippingCost;

        // Mengupdate order dengan nilai-nilai baru
        $order->update([
        ...
        // Mengarahkan kembali ke halaman detail order dengan pesan sukses
        return redirect()->route('admin.orders.index', $order->id)->with([
